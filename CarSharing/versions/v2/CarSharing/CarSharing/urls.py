...
from CarSharing_app.views import search_form, search,addCarSharingData,storeCarSharingData,register,welcome, profile, information, update_details, addDriverData,storeDriverData
...
urlpatterns = patterns('CarSharing_app.views',
    ...
    #url(r'^add_details/'. addDriverData),
